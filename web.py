...
diabetes_model= pickle.load(open(r"C:\Users\MohanRaj K\Downloads\internship\saved model\diabetes_model.sav",'rb'))
heart_model=pickle.load(open(r"C:\Users\MohanRaj K\Downloads\internship\saved model\heart_model.sav",'rb'))
parkinsons_model=pickle.load(open(r"C:\Users\MohanRaj K\Downloads\internship\saved model\parkinsons_model.sav",'rb'))
